...
nameEntry = CTkEntry(leftFrame, font=('arial', 15, 'bold'), width=150)
nameEntry.grid(row=1, column=1)

phoneLabel = CTkLabel(leftFrame, text='Phone', font=('arial', 18, 'bold'), text_color='white')
phoneLabel.grid(row=2, column=0, padx=15, pady=15, sticky='w')

phoneEntry = CTkEntry(leftFrame, font=('arial', 15, 'bold'), width=150)
phoneEntry.grid(row=2, column=1)

roleLabel = CTkLabel(leftFrame, text='Role', font=('arial', 18, 'bold'), text_color='white')
roleLabel.grid(row=3, column=0, padx=15, pady=15, sticky='w')
...
roleBox = CTkComboBox(leftFrame, values=role_options, width=150, font=('arial', 13, 'bold'), state='readonly')
roleBox.grid(row=3, column=1)

genderLabel = CTkLabel(leftFrame, text='Gender', font=('arial', 18, 'bold'), text_color='white')
genderLabel.grid(row=4, column=0, padx=15, pady=15, sticky='w')

gender_options = ['Male', 'Female']
genderBox = CTkComboBox(leftFrame, values=gender_options, width=150, font=('arial', 13, 'bold'), state='readonly')
genderBox.grid(row=4, column=1)

salaryLabel = CTkLabel(leftFrame, text='Salary', font=('arial', 18, 'bold'), text_color='white')
salaryLabel.grid(row=5, column=0, padx=15, pady=15, sticky='w')

salaryEntry = CTkEntry(leftFrame, font=('arial', 15, 'bold'), width=150)
...
style.configure('Treeview', font=('arial', 12, 'bold'), rowheight=25, background='#161C30', foreground='white')
